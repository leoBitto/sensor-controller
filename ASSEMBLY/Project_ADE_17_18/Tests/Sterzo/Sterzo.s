...
.data
  bufferIN:   .space 300
  bufferOUT:  .space 250
  IN:   .asciiz "/home/leonardo/Documenti/ASSEMBLY/Project_ADE_17_18/Data test IN/sterzoIN.txt"  # file di input
  OUT:  .asciiz "/home/leonardo/Documenti/ASSEMBLY/Project_ADE_17_18/Data test OUT/correttezzaSterzoOUT.txt"# file di output
...
.globl main
  ...
  main:
      ...
      loop:
            ...
            sb $s7, bufferOUT($s3)    # aggiungi uno spazio, codice 20 in bufOUT
            addiu $s3, $s3, 1         # aumenta di 1 il contatore del bufferOUT
