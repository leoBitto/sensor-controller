...
L1: # n >= 1
	...
	lw $a0,0($sp) 	 # ripristina i valori salvati in 
				 # precedenza nello stack frame: 
				 # parametro e indirizzo di ritorno
	lw $ra,4($sp)
	addi $sp,$sp,8 	 # ripristina lo stack frame
...
main:
	addi $sp, $sp, -4
	sw $ra, 0($sp)
	li $a0,5	       # imposta a 5 il parametro per la 
                       # chiamata a fattoriale
